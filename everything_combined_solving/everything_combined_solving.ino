...
#define OC0A 6 //6번핀 사용 쿨러 회전을 위한 핀., PORTD의 6번 비트
#define OC2B 3 //3번핀 사용 피에조 부조를 위한 핀. ,PORTD의 3번 비트
#define Relay_controll 7 //릴레이 제어하는 핀.
...
void loop() {
  ...
  if(temperature <= 18){  //18도 이하일때
    ...
    //팬 켜기
    PORTD |= (1<<OC0A);  // OC0A(PORTD의 6번비트)출력 주기
